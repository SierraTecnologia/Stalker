    ...
    Vue.component('media-manager', {
        ...
        methods: {
            getFiles: function() {
                var vm = this;
                vm.is_loading = true;
                $.post('{{ route('admin.stalker.media.files') }}', { folder: vm.current_folder, _token: '{{ csrf_token() }}', details: vm.details }, function(data) {
                    vm.files = [];
            ...
            renameFile: function(object) {
                ...
                $.post('{{ route('admin.stalker.media.rename') }}', {
            ...
            createFolder: function(e) {
                ...
                $.post('{{ route('admin.stalker.media.new_folder') }}', { new_folder: vm.current_folder+'/'+name, _token: '{{ csrf_token() }}' }, function(data) {
                    if(data.success == true){
            ...
            deleteFiles: function() {
                ...
                var vm = this;
                $.post('{{ route('admin.stalker.media.delete') }}', {
            ...
            moveFiles: function(e) {
                ...
                $.post('{{ route('admin.stalker.media.move') }}', {
                    path: vm.current_folder,
                    files: vm.selected_files,
            ...
            crop: function(mode) {
                ...
                $.post('{{ route('admin.stalker.media.crop') }}', postData, function(data) {
                    if (data.success) {
        ...
        mounted: function() {
            ...
            if (this.allowUpload && !dropzone.hasClass('dz-clickable')) {
                dropzone.dropzone({
                    timeout: 180000,
                    url: '{{ route('admin.stalker.media.upload') }}',
