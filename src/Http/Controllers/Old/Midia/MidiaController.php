...
namespace Artista\Http\Controllers\Features\Midia;

use Artista\Models\Digital\Midia\Photo;
use Artista\Models\Digital\Midia\PhotoAlbum;
use Artista\Services\Midia\MidiaService;
