<?php
namespace Artista\Console\External\Explorer;

use League\CLImate\CLImate;
use Artista\Logic\Output\AbstractOutput;
use Artista\Logic\Output\Filter\DiffOutputFilter;
use ReflectionMethod;
use SebastianBergmann\Diff\Parser;
use SebastianBergmann\Git\Git;
use UnexpectedValueException;
use Artista\Spider\SpiderLinuxCommand;
...
class DirectoryExplorer
{
    ...
    public function getAnalyser()
    {
        ...
        foreach ($paths as $path) {
            $spider = new \Artista\Spider\Directory($path);
            dd($spider->run());
            // $spider = new \Artista\Pipelines\Finder\Directory($path);
            // $pipeline->process(
